...
void TEST_Div1(INT64 na, INT64 nb)
{
	CBigInt x, y, z;
...
void TEST_DivPow2(int na, int nPow2)
{
	CBigInt x,y,z;
	x = na;
	x.DivPow2(nPow2);

	int nResTest = na >> nPow2;
	y = nResTest;
...
{
	TEST_DivPow2(10, 2);
	TEST_DivPow2(100000, 2);
	TEST_DivPow2(99990741, 7);
	TEST_DivPow2(999990741, 8);
	...
	TEST_Div1(4294968273, 292604875);
	TEST_Div1(1255445312, 10);
...
//				  "139221578786736675480792904055773408246814158120981180980253974860784918464552");
	...
	TEST_Div1_Str("0x0001351fc78122a1d1ff9e83b3b753d03c8626932a74edd852ba937b856d854d",
				  "0x000095cab5d8c7f02f9b36a24e66f0638a7360f4c037bd2ee2fcfada3c9d54d1",
				  "2");
